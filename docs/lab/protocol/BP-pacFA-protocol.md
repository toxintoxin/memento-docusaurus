...
THPTA(Tris(3-hydroxypropyltriazolylmethyl)amine), SIGMA, 762342  
Azide-fluor 488, SIGMA, 760765  

preparation:  
500mM copper sulfate stock: 7.98g溶解到80ml去离子水中, 定容到100ml  
常温保存  
100mM THPTA stock: 1 mg + 23 μl DMSO  
stored at -20  
2mM azide-A488 stock:  1 mg + 870 μl DMSO  
stored at -20  

click mix:  
1mM copper sulfate  
1mM sodium ascorbate  
100μM THPTA  
2μM azide-A488  
in PBS  

当天配置50mM的抗坏血酸, 每20mg加2270μlPBS, 取所需量的体积用PBS稀释到1mM, 再加入其他试剂

1. 100μM OA诱导脂滴，具体时间视细胞系决定，Hela细胞24h，Huh7细胞3h(为了成像，结束诱导时具有60%左右的confluence，据此处把握一开始seeding的细胞量)
2. wash twice with HBSS
3. incubate with 2μM BP-pacFA in HBSS for 30min at 37°C
...
6. expose to 365nm light for 10s to cross-link on ice, and immediately washed twice by cold PBS
7. covered with ice-cold methanol (-20°C) for 20min on ice
8. wash ? with MeOH for 5min each time
9. wash three times with PBS for 5min each time
10. add click mix (200μl for 24-well plates, 70μl for 96-well plates)
11. the reaction was allowed to proceed for 1 h in the dark
12. wash twice with PBS to remove the click mix
